...
public interface Zone {
    ...
    /**
     * Returns a zone representing the difference (A \ B): points in this zone
     * that are NOT in the other zone.
     */
     ...
     * A translation is inside if its distance to the center is less than the radius.
     */
     ...
     * A translation is inside if its x and y coordinates fall within the bounding box.
     */
     ...
     *
     * Uses a cross-product (winding) approach: for each edge of the polygon,
     * the point must be on the same side (left side for CCW winding).
     * Works correctly for convex polygons. For concave polygons, use a
     * ray-casting approach instead.
     */
