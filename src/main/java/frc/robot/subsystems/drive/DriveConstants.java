...
public final class DriveConstants {
  ...
  public static final double kDriveBaseRadius =
      Math.max(
          Math.max(
              Math.hypot(ModuleConstants.FrontLeft.LocationX, ModuleConstants.FrontLeft.LocationY),
              Math.hypot(
  ...
  public static final RobotConfig kPathplannerConfig =
      new RobotConfig(
          ...
          new ModuleConfig(
              ...
              kWheelCOF,
              DCMotor.getKrakenX60(1).withReduction(ModuleConstants.FrontLeft.DriveMotorGearRatio),
