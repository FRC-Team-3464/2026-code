...
public class FlywheelIOTalonFX implements FlywheelIO {
    ...
    public FlywheelIOTalonFX(int motorID) {
        ...
        motorConfig = new TalonFXConfiguration().withSlot0(FlywheelConstants.kGains)
        ...
        BaseStatusSignal.setUpdateFrequencyForAll(50, velocitySignal, accelerationSignal, voltageSignal, currentSignal);
        motor.optimizeBusUtilization();
    }

    @Override
    public void updateInputs(FlywheelIOInputs inputs) {
        inputs.connected = BaseStatusSignal.refreshAll(velocitySignal, accelerationSignal, voltageSignal, currentSignal)
                .isOK();
