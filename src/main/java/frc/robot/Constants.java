...
public final class Constants {
    ...
    public static final class DriveConstants {
        ...
        public static final double kOdometryFrequency = ModuleConstants.kCANBus.isNetworkFD() ? 250.0 : 100.0;
    ...
    public static final class ShooterConstants {
        ...
        public static final class TurretConstants {
            ...
            // +X = Forward, +Y = Left
            public static final Transform3d kRobotToLeftTurret = new Transform3d(Inches.of(3.749), Inches.of(8.186),
                    Inches.of(13.401), Rotation3d.kZero);

            public static final Transform3d kRobotToRightTurret = new Transform3d(Inches.of(3.749), Inches.of(-8.314),
                    Inches.of(13.401), Rotation3d.kZero);
        }
        ...
        public static final class HoodConstants {
            ...
            public static final Transform3d kRobotToLeftHood = new Transform3d(
                    Inches.of(7.268715), Meters.of(0.20792316), Inches.of(16.018516), Rotation3d.kZero);

            public static final Transform3d kRobotToRightHood = new Transform3d(
                    Inches.of(-7.270121),
                    Inches.of(-(12.062888 - (7.5 / 2.0))),
                    Inches.of(16.018516),
                    Rotation3d.kZero);

            public static final Transform3d kLeftTurretToLeftHood = GeomUtil.toPose3d(HoodConstants.kRobotToLeftHood)
                    .minus(
                            GeomUtil.toPose3d(TurretConstants.kRobotToLeftTurret)
                                    .plus(
                                            new Transform3d(
                                                    Inches.of(7.268715), Inches.of(0), Inches.of(0),
                                                    new Rotation3d())));

            public static final Transform3d kRightTurretToRightHood = GeomUtil.toPose3d(HoodConstants.kRobotToRightHood)
                    .minus(
                            GeomUtil.toPose3d(TurretConstants.kRobotToRightTurret)
                                    .plus(
                                            new Transform3d(
                                                    Inches.of(-7.270121), Inches.of(0), Inches.of(0),
                                                    new Rotation3d())));
