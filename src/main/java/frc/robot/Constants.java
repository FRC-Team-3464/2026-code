...
public final class Constants {
    ...
    public static final class DriveConstants {
        ...
        public static final class ModuleConfigs {
            ...
            public static final ModuleConfig FrontLeft = new ModuleConfig(1, 2, 19,
                    Rotation2d.fromDegrees(304.36523 - 180));

            /** Module 1 (front right) configs. */
            public static final ModuleConfig FrontRight = new ModuleConfig(2, 4, 20, Rotation2d.fromDegrees(206.455));

            /** Module 2 (back left) configs. */
            public static final ModuleConfig BackLeft = new ModuleConfig(5, 6, 21,
                    Rotation2d.fromDegrees(35.419922 + 180));

            /** Module 3 (back right) configs. */
            public static final ModuleConfig BackRight = new ModuleConfig(7, 8, 22, Rotation2d.fromDegrees(116.89453));
        }
    ...
    public static class OperatorConstants {
        public static final Joystick auxStick = new Joystick(7);
